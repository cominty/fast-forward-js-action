...
function run() {
    return __awaiter(this, void 0, void 0, function () {
        var github_token, success_message, failure_message, failure_message_same_stage_and_prod, failure_message_diff_stage_and_prod, comment_messages, status_name, update_status, set_status, prod_branch, stage_branch, client, fastForward, ff_status;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    status_name = core.getInput('status_name') || "fast-forward-merge";
                    ...
                    return [4 /*yield*/, fastForward.async_merge_fast_forward(client, set_status, status_name)];
                case 1:
                    ff_status = _a.sent();
