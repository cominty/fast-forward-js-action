...
var IDLE_DESCRIPTION = "Comment '/merge' to merge PR";
var FastForwardAction = /** @class */ (function () {
    ...
    ;
    FastForwardAction.prototype.async_merge_fast_forward = function (client, set_status, status_name) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, client.set_pull_request_status(pr_number, "success", status_name)];
                    case 1:
                        _a.sent();
                        _a.label = 2;
                    case 2:
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, client.set_pull_request_status(pr_number, "failure", status_name)];
                    case 5:
                        _a.sent();
                        _a.label = 6;
                    case 6: return [2 /*return*/, false];
                    case 7:
                        if (!set_status) return [3 /*break*/, 9];
                        return [4 /*yield*/, client.set_pull_request_status(pr_number, "pending", status_name, IDLE_DESCRIPTION)];
                    case 8:
                        _a.sent();
                        _a.label = 9;
